...
#     surprise_labels = [6 for i in range(len(surprise_paths))]
    ...
    labels = np.array(angry_labels + disgust_labels + happy_labels + \
    ...
    paths = np.array(angry_paths + disgust_paths + happy_paths + neutral_paths + \
                          sad_paths)
